...
- **Status:** Proposed, partially implemented (PR2 state machine + PR3 adapter + PR4 runtime bridge + PR5 shadow verification delivered; feature-flagged via `GRINDER_GRID_V2_ENABLED` / `GRINDER_GRID_V2_SHADOW`, default off). Existing doc-26 code remains operational.
