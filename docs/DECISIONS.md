...
- **Status:** Proposed, partially implemented (PR2 state machine + PR3 adapter + PR4 runtime bridge + engine wiring delivered; feature-flagged via `GRINDER_GRID_V2_ENABLED`, default off). Existing doc-26 code remains operational.
