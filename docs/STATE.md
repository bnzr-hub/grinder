...
- **Two-Sided Rolling Window Grid** (doc-27):
  ...
  - **Active ML Phase 3b (doc-36):** ML adjust wired into `ActiveSelector` via `ShadowSelector` delegation. Same bounded model, reuses ML env vars. All Phase 2 safety preserved (hysteresis, budget, graceful_exit_only, fail-safe). 9 tests.
