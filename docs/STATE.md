...
- **Two-Sided Rolling Window Grid** (doc-27):
  - **Status:** PR2 delivered. Pure state machine implemented (`src/grinder/grid_v2/`). 78 tests, all passing.
  - **Spec:** `docs/27_TWO_SIDED_ROLLING_WINDOW_GRID_SPEC.md` (sections 1-21, including PR2 contract clarifications 21.1-21.16).
  ...
  - **Implementation plan:** PR1 (spec) -> **PR2 (state machine) [DONE]** -> PR3 (reconciliation) -> PR4 (execution) -> PR5 (paper/shadow) -> PR6 (live ceremony).
