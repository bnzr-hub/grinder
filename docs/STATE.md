...
- **Two-Sided Rolling Window Grid** (doc-27):
  - **Status:** PR6 delivered + post-ceremony hardening. Live ceremony PASSED (2026-03-18). 26 shadow tests (13 classes) + 48 bridge tests (26 classes) + 99 adapter tests (16 classes) + 78 SM tests, all passing.
