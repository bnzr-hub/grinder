...
- **Phase C2b (live deactivation proof):** [TOOLING READY] `scripts/deactivation_ceremony.py` — bounded shutdown cleanup ceremony: pre-flight → trading → SIGINT → cleanup-on-exit → post-verify. Runbook: `docs/runbooks/39_SYMBOL_DEACTIVATION_CEREMONY.md` (ADR-130). Proof pending operator execution.
