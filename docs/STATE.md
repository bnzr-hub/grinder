...
- **Two-Sided Rolling Window Grid** (doc-27):
  - **Status:** PR6 delivered. Live ceremony PASSED (2026-03-18). 26 shadow tests (13 classes) + 42 bridge tests (23 classes) + 99 adapter tests (16 classes) + 78 SM tests, all passing.
