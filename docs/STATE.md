...
- **Phase C2b (live deactivation proof):** [DONE] `scripts/deactivation_ceremony.py` — bounded live ceremony: pre-flight → trading → SIGINT deactivation → cleanup-on-exit → post-verify. Runbook: `docs/runbooks/39_SYMBOL_DEACTIVATION_CEREMONY.md` (ADR-130). Live proof pending operator execution.
